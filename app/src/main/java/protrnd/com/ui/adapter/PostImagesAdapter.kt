...
class PostImagesAdapter(private val activity: NewPostActivity? = null, private val images: List<String>? = null, val uri: MutableList<Uri>? = null): RecyclerView.Adapter<ImageListViewHolder>() {
