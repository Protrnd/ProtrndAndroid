...
import protrnd.com.ui.notification.SocialsNotificationFragment
import protrnd.com.ui.notification.TransactionNotificationFragment

class NotificationTabAdapter(fm: FragmentManager, lifecycle: Lifecycle): FragmentStateAdapter(fm,lifecycle) {
